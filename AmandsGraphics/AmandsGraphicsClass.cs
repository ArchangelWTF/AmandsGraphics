...
public class AmandsGraphicsClass : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        {
            HoldingBreath = Player.Physical.HoldingBreath;
        }
    ...
    public void UpdateAmandsGraphics()
    {
        if (AmandsGraphicsPlugin.HealthEffectHit.Value == EEnabledFeature.On)
        {
            ...
            {
                amandsHitEffectClass = gameObject.AddComponent<AmandsHitEffectClass>();
            }
        }
        else
        {
        ...
        if (mBOIT_Scattering != null)
        {
            switch (scene)
            {
                case "Sandbox_Scripts":
                    mBOIT_Scattering.ZeroLevel = defaultMBOITZeroLevel + AmandsGraphicsPlugin.GroundZeroFogLevel.Value;
                    break;
                case "City_Scripts":
                    mBOIT_Scattering.ZeroLevel = defaultMBOITZeroLevel + AmandsGraphicsPlugin.StreetsFogLevel.Value;
                    break;
                case "Laboratory_Scripts":
                    break;
                case "custom_Scripts":
                    mBOIT_Scattering.ZeroLevel = defaultMBOITZeroLevel + AmandsGraphicsPlugin.CustomsFogLevel.Value;
                    break;
                case "Lighthouse_Scripts":
                    mBOIT_Scattering.ZeroLevel = defaultMBOITZeroLevel + AmandsGraphicsPlugin.LighthouseFogLevel.Value;
                    break;
                case "Shopping_Mall_Scripts":
                    mBOIT_Scattering.ZeroLevel = defaultMBOITZeroLevel + AmandsGraphicsPlugin.InterchangeFogLevel.Value;
                    break;
                case "woods_Scripts":
                    mBOIT_Scattering.ZeroLevel = defaultMBOITZeroLevel + AmandsGraphicsPlugin.WoodsFogLevel.Value;
                    break;
                case "Reserve_Base_Scripts":
                    mBOIT_Scattering.ZeroLevel = defaultMBOITZeroLevel + AmandsGraphicsPlugin.ReserveFogLevel.Value;
                    break;
                case "shoreline_scripts":
                    mBOIT_Scattering.ZeroLevel = defaultMBOITZeroLevel + AmandsGraphicsPlugin.ShorelineFogLevel.Value;
                    break;
            }
        }
    ...
    private void ResetGraphics()
    {
        if (mBOIT_Scattering != null)
        {
            mBOIT_Scattering.ZeroLevel = defaultMBOITZeroLevel;
        }
        foreach (KeyValuePair<Light,float> changedLight in registeredLights)
        {
            changedLight.Key.range = changedLight.Value;
    ...
    {
        if (AmandsToggleTextUIGameObject == null)
        {
            return;
        }
    ...
    public static void DestroyGameObjects()
    {
        if (AmandsToggleTextUIGameObject != null)
        {
            Destroy(AmandsToggleTextUIGameObject);
        }
    }
}
