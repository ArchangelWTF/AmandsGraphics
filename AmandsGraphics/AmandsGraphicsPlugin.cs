...
public class AmandsGraphicsPlugin : BaseUnityPlugin
{
    ...
    private IEnumerator CreateGraphicsHookAfterInit()
    {
        yield return null;
    ...
    private static void CreateGraphicsHook()
    {
        var graphics = new GameObject("AmandsGraphics");
        graphics.transform.SetParent(null);
        DontDestroyOnLoad(graphics);
        AmandsGraphicsClass = graphics.AddComponent<AmandsGraphicsClass>();
    }
